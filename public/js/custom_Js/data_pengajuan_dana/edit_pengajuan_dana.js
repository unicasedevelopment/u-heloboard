$(document).ready(function() {
    ...
    function get_data_pajak(id_kategori){
        ...
        if (id_kategori <= 2 ){
            if(id_kategori ==1){
                ...
                var status_pajak = [pajak_1,pajak_2,pajak_3,pajak_4,pajak_5,pajak_6,pajak_7]
                ...
                var checkbox_pajak = [checkbox_pajak_1,checkbox_pajak_2,checkbox_pajak_3,checkbox_pajak_4,checkbox_pajak_5,checkbox_pajak_6,checkbox_pajak_7]
    ...
    $('#form_edit_pengajuan_dana').on('submit', function(e) {
        ...
        $.ajax({
            type: "post",
            url: "/data_pengajuan_dana/"+id_pengajuan,
            data: form_data,
            processData: false,
            contentType: false,
            dataType: 'JSON',
