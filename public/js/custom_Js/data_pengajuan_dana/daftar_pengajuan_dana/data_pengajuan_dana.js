$(document).ready(function() {
    ...
    var table = $('#myTable').DataTable({
        ...
        "info": true,
        "autoWidth": false,
        "ajax": 'get_daftar_pengajuan_dana/0',
        "columns": [
            {
                data: 'no_surat',
    ...
    table_function('get_daftar_pengajuan_dana/0');
    ...
    $('#custom-tabs-four-pengajuan-tab').on('click', function(e){
        ...
        var url = 'get_daftar_pengajuan_dana/0';
    ...
    $('#custom-tabs-four-menunggu-acc-spv-tab').on('click', function(e){
        ...
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_daftar_pengajuan_dana/1';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_daftar_pengajuan_dana/1',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-menunggu-acc-finance-tab').on('click', function(e){
        ...
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_daftar_pengajuan_dana/2';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_daftar_pengajuan_dana/2',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-dalam-proses-tab').on('click', function(e){
        ...
        var url = 'get_daftar_pengajuan_dana/34';
        document.querySelector('#field_page').innerHTML = field_page;
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_daftar_pengajuan_dana/34',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-selesai-tab').on('click', function(e){
        ...
        var url = 'get_daftar_pengajuan_dana/5';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_daftar_pengajuan_dana/5',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-ditolak-tab').on('click', function(e){
        ...
        $('#form_edit_pengajuan_dana').trigger("reset");
        document.querySelector('#field_page').innerHTML = field_page;
        var url = 'get_daftar_pengajuan_dana/7';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_daftar_pengajuan_dana/7',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-batal-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        document.querySelector('#field_page').innerHTML = field_page;
        var url = 'get_daftar_pengajuan_dana/6';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_daftar_pengajuan_dana/6',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
