$(document).ready(function() {
    ...
    var table = $('#myTable').DataTable({
        ...
        "info": true,
        "autoWidth": false,
        "ajax": 'get_approval_1_pengajuan_dana/approval_1',
        "columns": [
            {
                data: 'no_surat',
    ...
    function set_informasi_status_pengajuan(data){
        ...
        if(data.status_approval_1 != 'yes' && data.status_pengajuan == 1 ){
    ...
    function enable_edit(data,kondisi){
        // document.getElementById('btn_save_field').innerHTML = '';
        ...
        if(kondisi != true){
            ...
            if(data.status_approval_1 != 'yes' && data.status_pengajuan == 1 ){
                var btn =   '<button type="button" class="btn btn-sm btn-danger" id="btn_reject_spv">Tolak <i class="fas fa-times"></i></button>'+
                '<button type="button" class="btn btn-sm btn-primary" id="btn_approval_spv">Setujui<i class="fas fa-check"></i></button>';
                document.getElementById('btn_approval_1_field').innerHTML = btn;

                $('#btn_reject_spv').on('click',function(){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "post",
                                url: "/approval_1_pengajuan_dana/"+data.id+"/reject_1",
                ...
                $('#btn_approval_spv').on('click',function(){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "post",
                                url: "/approval_1_pengajuan_dana/"+data.id+"/approval_1",
                                success: function(response) {
                                    console.log(response.status)
                                    Swal.fire({
                                        title: "Sukses",
                                    ...
                                    document.getElementById('btn_approval_1_field').innerHTML = '';
                                    set_informasi_status_pengajuan(response.data)
                                },
                                error: function(error) {
                                console.log('gagal');
    ...
    function table_function(url){
        ...
        table.on('draw', function(e) {
            ...
            $('.link-nomor-arsip-pengajuan-dana').on('click',function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/approval_1_pengajuan_dana/" + id_pengajuan + "/edit",
                    success: function(response) {
    ...
    table_function('get_approval_2_pengajuan_dana/approval_1');
    ...
    $('#custom-tabs-four-pengajuan-tab').on('click', function(e){
        ...
        var url = 'get_approval_1_pengajuan_dana/approval_1';
    ...
    $('#custom-tabs-four-menunggu-acc-spv-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_approval_1_pengajuan_dana/1';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_1_pengajuan_dana/1',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-menunggu-acc-finance-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_approval_1_pengajuan_dana/2';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_1_pengajuan_dana/2',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-dalam-proses-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        ...
        var url = 'get_approval_1_pengajuan_dana/34';
        document.querySelector('#field_page').innerHTML = field_page;
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_1_pengajuan_dana/34',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-selesai-tab').on('click', function(e){
        ...
        var url = 'get_approval_1_pengajuan_dana/5';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_1_pengajuan_dana/5',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-ditolak-tab').on('click', function(e){
        ...
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        document.querySelector('#field_page').innerHTML = field_page;
        var url = 'get_approval_1_pengajuan_dana/7';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_1_pengajuan_dana/7',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
