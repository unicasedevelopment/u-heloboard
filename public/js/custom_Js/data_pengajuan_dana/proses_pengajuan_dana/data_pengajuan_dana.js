$(document).ready(function() {
    ...
    var table = $('#myTable').DataTable({
        ...
        "info": true,
        "autoWidth": false,
        "ajax": 'get_proses_pengajuan_dana/proses',
        "columns": [
            {
                data: 'no_surat',
    ...
    $('#custom-tabs-four-proses-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        ...
        var url = 'get_proses_pengajuan_dana/proses';
    ...
    $('#custom-tabs-four-unpaid-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_proses_pengajuan_dana/unpaid';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_proses_pengajuan_dana/unpaid',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-paid-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_proses_pengajuan_dana/paid';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_proses_pengajuan_dana/paid',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    function set_informasi_status_pengajuan(data){
        ...
        if(data.status_pemrosesan == 'paid'){
            ...
            // document.getElementById('btn_paid_field').innerHTML = '<button type="button" class="btn btn-sm btn-primary" id="btn_paid">Selesaikan Pembayaran <i class="fas fa-check"></i></button>';
        }else{
            document.getElementById('status_paid').innerHTML = 'Belum Dibayar';
            // document.getElementById('btn_paid_field').innerHTML = '';
        }
    ...
    function enable_edit(data,kondisi){
        if(kondisi != true){
            ...
            $('#file_bukti_bayar').show();
            if(data.status_pemrosesan == 'unpaid'){
                // console.log(data)
                document.getElementById('btn_paid_field').innerHTML = '<button type="button" class="btn btn-sm btn-primary" id="btn_paid">Selesaikan Pembayaran <i class="fas fa-check"></i></button>';
                $('#btn_paid').on('click',function(){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "post",
                                url: "/proses_pengajuan_dana/"+data.id+"/paid",
    ...
    function table_function(url){
        ...
        table.on('draw', function(e) {
            ...
            $('.link-nomor-arsip-pengajuan-dana').on('click',function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/proses_pengajuan_dana/" + id_pengajuan + "/edit",
                    success: function(response) {
    ...
    table_function('get_proses_pengajuan_dana/proses');
