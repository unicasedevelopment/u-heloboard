$(document).ready(function() {
    ...
    $('#form_edit_pengajuan_dana').on('submit', function(e) {
        ...
        var file_bukti_bayar = document.getElementById('file_bukti_bayar').files[0];
        form_data.append('file_bukti_bayar',file_bukti_bayar == undefined ? null:file_bukti_bayar);
        ...
        $.ajax({
            type: "post",
            url: "/proses_pengajuan_dana/"+id_pengajuan,
            data: form_data,
            processData: false,
            contentType: false,
            dataType: 'JSON',
