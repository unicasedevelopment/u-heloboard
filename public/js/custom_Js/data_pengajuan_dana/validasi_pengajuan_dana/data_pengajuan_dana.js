$(document).ready(function() {
    ...
    var table = $('#myTable').DataTable({
        ...
        "info": true,
        "autoWidth": false,
        "ajax": 'get_validasi_pengajuan_dana/validasi',
        "columns": [
            {
                data: 'no_surat',
    ...
    $('#custom-tabs-four-validasi-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        ...
        var url = 'get_validasi_pengajuan_dana/validasi';
    ...
    $('#custom-tabs-four-invalid-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_validasi_pengajuan_dana/invalid';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_validasi_pengajuan_dana/invalid',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-valid-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_validasi_pengajuan_dana/valid';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_validasi_pengajuan_dana/valid',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    function set_dokumen_pengajuan(dokumen_pengajuan){
        if(dokumen_pengajuan != null){
            ...
            if(dokumen_pengajuan.file_fp_internal != null){
                $('#file_fp_internal_field').attr("href","/storage/"+dokumen_pengajuan.file_fp_internal);
                $('#file_fp_internal_field').show();
            ...
            if(dokumen_pengajuan.file_bukti_bayar != null){
                $('#file_bukti_bayar_field').attr("href","/storage/"+dokumen_pengajuan.file_bukti_bayar);
                $('#file_bukti_bayar_field').show();
    ...
    function set_informasi_status_pengajuan(data){
        ...
        if(data.status_validasi == 'yes'){
            document.getElementById('status_validasi').innerHTML = 'Sudah Divalidasi';
        }else{
    ...
    function enable_edit(data,kondisi){
        ...
        $('.btn-lampiran').addClass('btn-defaul text-secondary');
            ...
            $('#file_fp_internal').show();
            if(data != 'yes'){
                document.getElementById('btn_validasi_field').innerHTML = '<button type="button" class="btn btn-sm btn-primary" id="btn_validasi">Validasi <i class="fas fa-check"></i></button>';
            }else{
                document.getElementById('btn_validasi_field').innerHTML = '';
            }
            $('#btn_validasi').on('click',function(){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "post",
                            url: "/validasi_pengajuan_dana/"+id_pengajuan+"/validasi",
    ...
    function table_function(url){
        ...
        table.on('draw', function(e) {
            ...
            $('.link-nomor-arsip-pengajuan-dana').on('click',function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/validasi_pengajuan_dana/" + id_pengajuan + "/edit",
                    success: function(response) {
                        ...
                        enable_edit(data.status_validasi,false);

                        $('#btn-edit').on('click', function(){
                            enable_edit(data.status_validasi,true);
                        });
                    },
                    error: function(error) {
                        console.log(error);
    ...
    table_function('get_validasi_pengajuan_dana/validasi');
