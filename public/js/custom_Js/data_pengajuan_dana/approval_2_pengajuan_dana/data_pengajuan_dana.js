$(document).ready(function() {
    ...
    var table = $('#myTable').DataTable({
        ...
        "info": true,
        "autoWidth": false,
        "ajax": 'get_approval_2_pengajuan_dana/approval_2',
        "columns": [
            {
                data: 'no_surat',
        ...
        if(informasi_perpajakan != null){
            for (i = 0; i < informasi_perpajakan.length ; i++){
                ...
                if(informasi_perpajakan[i].id_jenis_pajak == 1){
                    ...
                    document.getElementById('checkbox_pajak_'+informasi_perpajakan[i].id_jenis_pajak).checked = true;
                    document.getElementById('status_pajak_'+informasi_perpajakan[i].id_jenis_pajak).removeAttribute('disabled');
                    document.getElementById('status_pajak_'+informasi_perpajakan[i].id_jenis_pajak).setAttribute('required','');
                    console.log('#'+'status_pajak_'+informasi_perpajakan[i].id_jenis_pajak+' = '+informasi_perpajakan[i].status_pajak);
                    $('#'+'status_pajak_'+informasi_perpajakan[i].id_jenis_pajak).val(informasi_perpajakan[i].status_pajak).trigger("change");
                }
            }
        }
    }
        ...
        if(informasi_lampiran != null){
            ...
            var tambah_lampiran =   '<div class="row item-lampiran" >'+
                                        '<div class="form-group col-md-4 mb-1">'+
                                            '<label id="label_lampiran_'+x+'" class="label_lampiran" for=""></label>'+
                                            '<input type="text" id="nama_lampiran" name="nama_lampiran[]" class="data_lampiran form-control form-control-sm" placeholder="Nama File" required>'+
                                        '</div>'+
                                        '<div class="form-group col-md-4 mb-1">'+
            ...
            for(i=0;i<informasi_lampiran.length;i++){
                var tambah_lampiran =   '<div class="row item-lampiran" >'+
                                        '<div class="form-group col-md-4 mb-1 lampiran">'+
                                            '<label id="label_lampiran_'+x+'" class="label_lampiran" for="" style="margin-top:0.5rem;"></label>'+
                                            '<input type="text" id="nama_lampiran" name="nama_lampiran[]" class="data_lampiran form-control form-control-sm" placeholder="Nama File" required>'+
                                        '</div>'+
                                        '<div class="form-group col-md-4 mb-1">'+
                                            '<div class="input-group">'+
                                                '<input type="file" id="file_lampiran_'+x+'" name="file_lampiran[]" class="form-control form-control-sm" required="true">'+
                                                '<div class="input-group-append">'+
                                                    '<a id="file_lampiran_field_'+x+'" href="#" target="_blank" class="btn btn-sm btn-secondary text-white btn-lampiran"> Lihat <i class="fa fa-file-contract"></i>'+
                                                    '</a>'+
                                                '</div>'+
                                            '</div>'+
                ...
                document.getElementById('label_lampiran_'+(i+1)).innerHTML = informasi_lampiran[i].nama_lampiran;
    ...
    function set_informasi_status_pengajuan(data){

        if(data.status_approval_1 == 'yes'){
            document.getElementById('status_approval_spv').innerHTML = 'Disetujui';
            // $('#btn_approval_spv').hide();
        }else{
            document.getElementById('status_approval_spv').innerHTML = 'Belum Disetujui';
            // $('#btn_approval_spv').show();
            // $('#btn_approval_spv').on('click',function(){
            ...
            //             $.ajax({
            //                 type: "post",
            //                 url: "/approval_pengajuan_dana/"+data.id+"/approval_1",
            //                 success: function(response) {
            //                     console.log(response.status)
            //                     Swal.fire({
            //                         title: "Sukses",
            //                         icon: 'success',
            //                         text: "Pengajuan Disetujui, Terima Kasih",
            //                         button: "Ok",
            //                         confirmButtonColor: '#7cd1f9',
            //                     })
            //                     set_informasi_status_pengajuan(response.data)
            //                 },
        ...
        if(data.status_approval_2 != 'yes' && data.status_pengajuan == 2){
            // var btn =   '<button type="button" class="btn btn-sm btn-danger" id="btn_reject_spv_finance">Tolak <i class="fas fa-times"></i></button>'+
            //             '<button type="button" class="btn btn-sm btn-primary" id="btn_approval_spv_finance">Setujui<i class="fas fa-check"></i></button>';
            document.getElementById('status_approval_spv_finance').innerHTML = 'Belum Disetujui';
            // document.getElementById('btn_approval_2_field').innerHTML = btn;

            // $('#btn_reject_spv_finance').on('click',function(){
            //     console.log('tombol berfungsi')
            //     Swal.fire({
            //         title: "Perhatian",
            //         icon: 'question',
            //         text: "Apakah Anda Yakin Manolak Pengajuan Ini?",
            //         // button: "Ok",
            //         confirmButtonColor: '#7cd1f9',
            //         showCancelButton: true,
            //         confirmButtonText: 'Ya',
            ...
            //             $.ajax({
            //                 type: "post",
            //                 url: "/approval_2_pengajuan_dana/"+data.id+"/reject_2",
            //                 success: function(response) {
            //                     console.log(response.status)
            //                     Swal.fire({
            //                         title: "Sukses",
            //                         icon: 'success',
            //                         text: "Berhasil Menolak Pengajuan, Terima Kasih",
            //                         button: "Ok",
            //                         confirmButtonColor: '#7cd1f9',
            //                     })
            //                     set_informasi_status_pengajuan(response.data)
            ...
            //     })
            // })
            // $('#btn_approval_spv_finance').on('click',function(){
            //     console.log('tombol berfungsi')
            //     Swal.fire({
            //         title: "Perhatian",
            //         icon: 'question',
            ...
            //             $.ajax({
            //                 type: "post",
            //                 url: "/approval_2_pengajuan_dana/"+data.id+"/approval_2",
            //                 success: function(response) {
            //                     console.log(response.status)
            //                     Swal.fire({
            //                         title: "Sukses",
            ...
            document.getElementById('status_approval_spv_finance').innerHTML = 'Disetujui';
            // document.getElementById('btn_approval_2_field').innerHTML = '';
        }

        if(data.status_pemrosesan == 'paid'){
            document.getElementById('status_paid').innerHTML = 'Sudah Dibayar';
        }else{
            document.getElementById('status_paid').innerHTML = 'Belum Dibayar';
            // $('#btn_paid').on('click',function(){
            //     console.log('tombol berfungsi')
            //     Swal.fire({
            //         title: "Perhatian",
            //         icon: 'question',
            //         text: "Apakah Anda Yakin Sudah Menyelesaikan Pembayaran Pengajuan Ini?",
            //         // button: "Ok",
            //         confirmButtonColor: '#7cd1f9',
            //         showCancelButton: true,
            //         confirmButtonText: 'Ya',
            ...
            //             $.ajax({
            //                 type: "post",
            //                 url: "/approval_pengajuan_dana/"+data.id+"/paid",
            //                 success: function(response) {
            //                     console.log(response.status)
            //                     Swal.fire({
            //                         title: "Sukses",
            //                         icon: 'success',
            //                         text: "Pembayaran pengajuan Selesai, Terima Kasih",
            //                         button: "Ok",
            //                         confirmButtonColor: '#7cd1f9',
            //                     })
            //                     set_informasi_status_pengajuan(response.data)
        ...
        if(data.status_validasi == 'yes'){
            document.getElementById('status_validasi').innerHTML = 'Valid';
            $('#btn-cetak').on('click', function(e){
                e.preventDefault();
                $.ajax({
                    type: "get",
                    url: "/approval_2_pengajuan_dana/"+data.id+"/cetak",
                    success: function(response) {
            ...
            document.getElementById('status_validasi').innerHTML = 'Belum Divalidasi';
            $('#btn-cetak').hide();
        }

    }

    function enable_edit(data,kondisi){
        // $('textarea').attr('disabled',true);
        // $('.select-pajak').attr('disabled',true);
    ...
    function table_function(url){
        ...
        table.on('draw', function(e) {
            ...
            $('#btn-batal').on('click', function(e){
                ...
                $('.select-pajak').attr('disabled',true);
                $('#page_edit_pengajuan_dana').hide()
                $('#field_page').show()
                document.getElementById('checkbox_lampiran').checked = false;
            ...
            $('.link-nomor-arsip-pengajuan-dana').on('click',function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/approval_2_pengajuan_dana/" + id_pengajuan + "/edit",
                    success: function(response) {
                        ...
                        $('#btn-edit').on('click', function(){
                            // console.log('tombol edit berfungsi');
                            enable_edit(data,true);
                        });
                    },
                    error: function(error) {
                        console.log(error);
    ...
    table_function('get_approval_2_pengajuan_dana/approval_2');
    ...
    $('#custom-tabs-four-pengajuan-tab').on('click', function(e){
        ...
        var url = 'get_approval_2_pengajuan_dana/approval_2';
        ...
        // $.ajax({
        //     type: "GET",
        //     url: "/get_approval_2_pengajuan_dana/pengajuan",
        //     success: function(response) {
        //         console.log(response);
        //         var data = response.data;
        //         console.log(data);
    ...
    $('#custom-tabs-four-menunggu-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_approval_2_pengajuan_dana/2';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_2_pengajuan_dana/2',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-disetujui-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        ...
        var url = 'get_approval_2_pengajuan_dana/34';
        document.querySelector('#field_page').innerHTML = field_page;
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_2_pengajuan_dana/34',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-selesai-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        ...
        var url = 'get_approval_2_pengajuan_dana/5';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_2_pengajuan_dana/5',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-ditolak-tab').on('click', function(e){
        e.preventDefault();
        $('#field_page').show()
        // window.location.reload();
        $('#form_edit_pengajuan_dana').trigger("reset");
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        document.querySelector('#field_page').innerHTML = field_page;
        var url = 'get_approval_2_pengajuan_dana/7';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_2_pengajuan_dana/7',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
