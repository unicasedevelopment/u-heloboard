$(document).ready(function() {
    ...
    var table = $('#myTable').DataTable({
        ...
        "info": true,
        "autoWidth": false,
        "ajax": 'get_approval_pengajuan_dana/0',
        "columns": [
            {
                data: 'no_surat',
            ...
            $('#btn_approval_spv_finance').on('click',function(){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "post",
                            url: "/approval_pengajuan_dana/"+data.id+"/approval_2",
                            success: function(response) {
                                console.log(response.status)
                                Swal.fire({
                                    title: "Sukses",
        ...
        if(data.status_validasi == 'yes'){
            ...
            $('#btn_validasi').on('click',function(){
                ...
                Swal.fire({
                    title: "Perhatian",
                    icon: 'question',
                    text: "Apakah Anda Yakin Sudah Memvalidasi Perpajakan Pengajuan Ini?",
                    // button: "Ok",
                    confirmButtonColor: '#7cd1f9',
                    showCancelButton: true,
                    confirmButtonText: 'Ya',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "post",
                            url: "/approval_pengajuan_dana/"+data.id+"/validasi",
                            success: function(response) {
                                console.log(response.status)
                                Swal.fire({
                                    title: "Sukses",
                                    icon: 'success',
                                    text: "Validasi Pengajuan Dana Selesai, Terima Kasih",
                                    button: "Ok",
                                    confirmButtonColor: '#7cd1f9',
                                })
                                set_informasi_status_pengajuan(response.data)
    ...
    function enable_edit(kondisi){
        ...
        // if(kondisi <= 1){
        //     document.getElementById('btn_save_field').innerHTML = '<button type="submit" class="btn btn-sm btn-secondary text-white">Simpan</button>';
        ...
        // }else{
        //     document.getElementById('btn_save_field').innerHTML = '';
        //     // document.getElementById('btn_lampiran_field').innerHTML = '';
        //     // $('#checkbox_lampiran').attr('disabled',true);
        //     // $('.checkbox-pajak').attr('disabled',true);
        //     $('input').attr('disabled',true);
        //     $('select').attr('disabled',true);
        //     $('textarea').attr('disabled',true);
        //     $('#add_lampiran').hide();
    ...
    function table_function(url){
        table.on('draw', function(e) {
            ...
            $('.link-nomor-arsip-pengajuan-dana').on('click',function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/approval_pengajuan_dana/" + id_pengajuan + "/edit",
                    success: function(response) {
    ...
    table_function('get_approval_pengajuan_dana/0');
    ...
    $('#custom-tabs-four-pengajuan-tab').on('click', function(e){
        ...
        var url = 'get_approval_pengajuan_dana/0';
        ...
        // $.ajax({
        //     type: "GET",
        //     url: "/get_approval_pengajuan_dana/pengajuan",
        //     success: function(response) {
        //         console.log(response);
        //         var data = response.data;
        //         console.log(data);
    ...
    $('#custom-tabs-four-submited-tab').on('click', function(e){
        ...
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
            var url = 'get_approval_pengajuan_dana/1';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_pengajuan_dana/1',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
        ...
        // $.ajax({
        //     type: "GET",
        //     url: "/get_approval_pengajuan_dana/submited",
        //     success: function(response) {
        //         console.log(response);
        //         var data = response.data;
        //         console.log(data);
    ...
    $('#custom-tabs-four-approved-tab').on('click', function(e){
        ...
        var page_edit_pengajuan_dana = document.getElementById('page_edit_pengajuan_dana');
            page_edit_pengajuan_dana.style.display = 'none';
        var url = 'get_approval_pengajuan_dana/2';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_pengajuan_dana/2',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-processing-tab').on('click', function(e){
        ...
        var url = 'get_approval_pengajuan_dana/34';
        document.querySelector('#field_page').innerHTML = field_page;
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_pengajuan_dana/34',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-completed-tab').on('click', function(e){
        ...
        var url = 'get_approval_pengajuan_dana/5';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_pengajuan_dana/5',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
    ...
    $('#custom-tabs-four-cancelled-tab').on('click', function(e){
        ...
        $('#form_edit_pengajuan_dana').trigger("reset");
        document.querySelector('#field_page').innerHTML = field_page;
        var url = 'get_approval_pengajuan_dana/6';
        ...
        table = $('#myTable').DataTable({
            ...
            "info": true,
            "autoWidth": false,
            "ajax": 'get_approval_pengajuan_dana/6',
            "columns": [
                {
                    data: 'no_surat',
                    render: function (dataField) { return '<a class="link-nomor-arsip-pengajuan-dana" href="#" style="text-decoration: none;">'+dataField+'</a>'; },
