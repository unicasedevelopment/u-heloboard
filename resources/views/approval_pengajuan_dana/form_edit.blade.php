        ...
        <div id="all_form_field" style="">
                ...
                <table class="table table-sm " width="100%">
                        ...
                        <tr class="item_pajak_{{$pajak->id}}">
                            ...
                            <td class="text-center">
                                <div class="icheck-secondary d-inline">
                                    <input type="checkbox" class="checkbox-pajak" id="checkbox_pajak_{{$pajak->id}}">
                    ...
                    <tbody id="pajak_field_2" style="border-top:0px;display:none;">
                        ...
                        <tr class="item_pajak_1">
                            ...
                            <td class="text-center">
                                <div class="icheck-secondary d-inline">
                                    <input type="checkbox" class="checkbox-pajak" id="checkbox_pajak">
            ...
            <div class="card-body text-secondary" id="informasi_lampiran" style="display:none">
                ...
                <div class="">
                    ...
                    <div class="icheck-secondary d-inline" id="btn-lampiran-field">
                        <input type="checkbox" id="checkbox_lampiran">
                        <label for="checkbox_lampiran"></label>
                    </div>
                </div>
            ...
            <div class="card-body text-secondary row" id="informasi_pembayaran">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <button type="button" class="btn btn-sm btn-primary" id="btn_approval_spv">Setujui <i
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-3 col-form-label" id="status_approval_spv_finance"
                            style="font-weight:unset;"></label>
                        <div class="col-sm-5">
                            <button type="button" class="btn btn-sm btn-primary" id="btn_approval_spv_finance">Setujui
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <button type="button" class="btn btn-sm btn-primary" id="btn_paid">Selesaikan Pembayaran <i
                                    class="fas fa-check"></i></button>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <button type="button" class="btn btn-sm btn-primary" id="btn_validasi">Validasi <i
                                    class="fas fa-check"></i></button>
                        </div>
                    </div>
                </div>
            ...
            <div id="btn_save_field" class="form-group text-right">
