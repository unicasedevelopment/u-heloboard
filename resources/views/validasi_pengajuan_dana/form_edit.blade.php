            ...
            <div class="card-body text-secondary row" id="informasi_pembayaran">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <button class="btn btn-sm btn-primary" id="btn_approval_spv">Setujui <i
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-3 col-form-label" id="status_approval_spv_finance"
                            style="font-weight:unset;"></label>
                        <div class="col-sm-5">
                            <button class="btn btn-sm btn-primary" id="btn_approval_spv_finance">Setujui <i
                                    class="fas fa-check"></i></button>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <button class="btn btn-sm btn-primary" id="btn_paid">Selesaikan Pembayaran <i
                                    class="fas fa-check"></i></button>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <button class="btn btn-sm btn-primary" id="btn_validasi">Validasi <i
                                    class="fas fa-check"></i></button>
                        </div>
                    </div>
                </div>
