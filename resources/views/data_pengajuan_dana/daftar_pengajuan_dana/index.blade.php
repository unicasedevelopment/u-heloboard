        ...
        <div class="card card-secondary card-outline card-outline-tabs ">
            <div class="card-header p-0 border-bottom-0 ">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist" style="padding-bottom: 2px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-menunggu-acc-spv-tab" data-toggle="pill" href="#"
                            role="tab" aria-controls="custom-tabs-four-home" aria-selected="false">Menunggu Acc SPV</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-menunggu-acc-finance-tab" data-toggle="pill" href="#"
                            role="tab" aria-controls="custom-tabs-four-home" aria-selected="false">Menunggu Acc
                            Finance</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-dalam-proses-tab" data-toggle="pill" href="#"
                            role="tab" aria-controls="custom-tabs-four-home" aria-selected="false">Dalam Proses</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-batal-tab" data-toggle="pill" href="#" role="tab"
            ...
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                    <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel"
                        ...
                        @include('data_pengajuan_dana.daftar_pengajuan_dana.form_edit')
...
<script src="{{ asset ('js/custom_js/data_pengajuan_dana/daftar_pengajuan_dana/data_pengajuan_dana.js') }}">
</script>
<script src="{{ asset ('js/custom_js/data_pengajuan_dana/daftar_pengajuan_dana/edit_pengajuan_dana.js') }}">
</script>
