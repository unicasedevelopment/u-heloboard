            ...
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                    <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel"
                        ...
                        @include('data_pengajuan_dana.approval_1_pengajuan_dana.form_edit')
...
<script src="{{ asset ('js/custom_js/data_pengajuan_dana/approval_1_pengajuan_dana/data_pengajuan_dana.js') }}">
</script>
<script src="{{ asset ('js/custom_js/data_pengajuan_dana/approval_1_pengajuan_dana/edit_pengajuan_dana.js') }}">
</script>
