...
<head>
    ...
    <script nonce="fa540a59-e473-4329-99a2-18e4e41f0bfc">
        (function (w, d) {
...
<body class="hold-transition sidebar-mini">
    ...
    <script type="text/javascript" src="{{ asset('plugins/datatables-buttons/js/dataTables.buttons.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('plugins/datatables-buttons/js/buttons.bootstrap4.min.js') }}">
    </script>
    ...
    <script type="text/javascript" src="{{ asset('dist/js/adminlte.min.js?v=3.2.0') }}"></script>
