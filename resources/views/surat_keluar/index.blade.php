...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            @include('surat_keluar.form')
            @include('surat_keluar.form_edit')
            @include('surat_keluar.form_delete')
            <div class="card-header">
                <div class="row-cols-12 d-flex justify-content-between" style="padding:0px 1.25rem;">
                    ...
                    <a href="#" data-toggle="modal" data-target="#modal_form_surat_keluar"
                                ...
                                <tr class="odd " id="{{ $surats->id }}">
                                    ...
                                    <td class="text-center " style="vertical-align: middle;">
                                        ...
                                        <a href="{{ asset ('storage/' . $surats->file_surat)}}" target="_blank"
                                            ...
                                            data-bs-title="{{$surats->resume}}"><i class="fa fa-file-contract"></i></a>
                                        @else
                                        <a href="#" class="btn btn-sm btn-light text-secondary" data-bs-toggle="tooltip"
                                            data-bs-placement="left" data-bs-custom-class="custom-tooltip"
                                            data-bs-title="{{$surats->resume}}"><i class="fa fa-ban"></i></a>
                                        @endif
                                    </td>
                                    <td class="text-center text-white" style="vertical-align: middle;">
                                        <a href="#" data-toggle="modal" data-target="#modal_form_hapus_surat_keluar"
                                            class="btn btn-danger btn-sm btn-hapus-surat-keluar"><i
...
@section('javascript')
<script src="{{ asset ('js/custom_js/surat_keluar.js') }}"></script>
@endsection